    ...
    if metrics_path and metrics_path.exists():
        ...
        if run_info:
            ...
            run_info_html = (
                ...
                f"<tr><th>Device</th><td>{html.escape(str(run_info.get('device', '')))}</td></tr>"
                f"<tr><th>Requested Device</th><td>{html.escape(str(run_info.get('requested_device', '')))}</td></tr>"
                f"<tr><th>Torch Version</th><td>{html.escape(str(run_info.get('torch_version', '')))}</td></tr>"
                f"<tr><th>CUDA Available</th><td>{html.escape(str(run_info.get('cuda_available', '')))}</td></tr>"
                f"<tr><th>CUDA Device Count</th><td>{html.escape(str(run_info.get('cuda_device_count', '')))}</td></tr>"
                f"<tr><th>CUDA Device</th><td>{html.escape(str(run_info.get('cuda_device_name', '')))}</td></tr>"
                f"<tr><th>CUDA Capability</th><td>{html.escape(str(run_info.get('cuda_device_capability', '')))}</td></tr>"
                f"<tr><th>cuDNN Version</th><td>{html.escape(str(run_info.get('cudnn_version', '')))}</td></tr>"
                f"<tr><th>Git Commit</th><td>{html.escape(str(run_info.get('git_commit', '')))}</td></tr>"
                ...
                f"<tr><th>Epochs Requested</th><td>{html.escape(str(run_info.get('epochs_requested', '')))}</td></tr>"
                f"<tr><th>Epochs Completed</th><td>{html.escape(str(run_info.get('epochs_completed', '')))}</td></tr>"
                f"<tr><th>Stop Reason</th><td>{html.escape(str(run_info.get('stop_reason', '')))}</td></tr>"
                f"<tr><th>Early Stopped</th><td>{html.escape(str(run_info.get('early_stopped', '')))}</td></tr>"
                f"<tr><th>Patience Left</th><td>{html.escape(str(run_info.get('patience_left', '')))}</td></tr>"
